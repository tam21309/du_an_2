...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>DeskApp - Lắc Tay Store </title>
...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="public/vendors/images/deskapp-logo.svg" alt=""></div>
				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<img src="https://scontent.fdad3-4.fna.fbcdn.net/v/t39.30808-6/300956838_2695330577269533_5743395904903920628_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=raZ_ZWOLivYAX8o094-&_nc_ht=scontent.fdad3-4.fna&oh=00_AT-DNb9pRUL7flBLDh5EzUsBWQe7AoUykE0tJG8BQQfAhg&oe=635306D4" alt="">
						</span>
						<span class="user-name">Thảo Tâm</span>
					</a>
    ...
    <div class="left-side-bar">
		<div class="brand-logo">
			<a href="/index.html">
				<img src="/public/vendors/images/deskapp-logo" alt="" class="dark-logo">
				<img src="/public/vendors/images/deskapp-logo" alt="" class="light-logo">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="/nha_cung_cap/list.php" class="dropdown-toggle">
							<span class="micon dw dw-edit2"></span><span class="mtext">Nhà Cung Cấp</span>
						</a>
						<!-- <ul class="submenu">
					...
					<li>
						<a href="/product/list.php" class="dropdown-toggle">
							<span class="micon dw dw-library"></span><span class="mtext">Sản Phẩm</span>
						</a>
						<!-- <ul class="submenu">
					...
					<li>
						<a href="/customers/list.php" class="dropdown-toggle">
							<span class="micon dw dw-apartment"></span><span class="mtext"> Khách Hàng </span>
						</a>
						<!-- <ul class="submenu">
...
<div class="main-container">
        ...
        <div class="footer-wrap pd-20 mb-20 card-box">
				DeskApp - Bootstrap One Admin Template By <a href="/https://github.com/dropways" target="_blank">0901.170.243</a>
			</div>
		</div>
	</div>
	<!-- js -->
